...
public class GymListActivity extends Activity {
    ...
    private ListGymAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ListGymAdapter(this, gymList);
    ...
    private void init() {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), AddGymActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 2000) {
            if (adapter != null) {
                MainDB mainDB = MainDB.getInstance(this);
                adapter.setList(mainDB.gymDao().selectGym());
            }
        }
    }
}